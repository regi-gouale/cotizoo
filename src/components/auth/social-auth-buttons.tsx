...
export function SocialAuthButtons({
  ...
  // Déterminer l'URL de callback en fonction de la présence d'un token d'invitation
  const getCallbackURL = () => {
    if (invitationToken) {
      return `/auth/accept-invitation?token=${invitationToken}&tontineId=${tontineId || ""}`;
    }
    return "/dashboard";
  };
